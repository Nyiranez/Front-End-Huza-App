...
const About = () => {
  return (
    <div className='bg-gradient-to-r from-slate-900 to-blue-950 text-white px-32'>
        ...
        <div className=' flex mt-10 justify-between'>
            ...
            <div className=' mt-14 flex flex-col gap-10' >
                <h2 className=' text-3xl font-bold animate-pulse'> We are Develop Huza Based on Unemployement</h2>
