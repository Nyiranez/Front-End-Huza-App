            ...
            <div className=' flex mt-10 justify-between'>
                  <div className='relative'>
                   ...
                   <div className=' mt-14 flex flex-col gap-10' >
                      <h2 className={`${!mode ? "text-white" : "text-slate-500"} text-3xl font-bold animate-pulse`}> We Develop Huza Based on Unemployement</h2>
                      <p className={`${!mode ? "text-slate-500" : "text-slate-500"} `}>developing the Huza app with these features and functionalities,<br></br>
                      ...
                      <p className={`${!mode ? "text-slate-500" : "text-slate-500"} `}>Create a resource hub with articles, guides, and tutorials on job searching, <br></br>
