...
export const Contact = () => {
  ...
  return (
    <div className={` ${!mode ? 'bg-gradient-to-r from-slate-900 to-blue-950' : 'bg-white'} h-screen pt-40 `}>
      ...
      <div className="flex md:flex-row md:mt-12 flex-col space-y-8  mt-4  md:justify-center">
